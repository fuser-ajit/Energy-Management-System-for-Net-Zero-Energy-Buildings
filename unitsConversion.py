...
# $Date: 2021-05-21 15:45:37 -0700 (Wed, 19 May 2021) $
# $Rev: 5945 $
...
def m3_s2gpm(m3_s):
    """m^3/s -> gpm"""
    return cfm2gpm(m3_s2cfm(m3_s))

def m3_s2gph(m3_s):
    """m^3/s -> gph"""
    return m3_s2gpm(m3_s) / min2hr(1)
...
def J_kgK2Btu_lbR(x):   # By mass
    """J/(kg-K) -> Btu/(lbm-R)"""
    return x / Btu_lbR2J_kgK(1.0)
...
def Btu2kWh(x):
    """Btu -> kWh"""
    return (1/kWh2Btu(1))*x

def MBtu2kWh(x):
    """MBtu -> kWh"""
    return (1/kWh2MBtu(1))*x
